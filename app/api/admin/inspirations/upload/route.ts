...
import { InspirationUploadSchema } from '@/lib/schemas/inspirations';
...
export async function POST(req: NextRequest) {
    ...
    const parsed = InspirationUploadSchema.safeParse(fields);
    if (!parsed.success) {
    ...
    try {
        ...
        const inspiration = await inspirationService.uploadFromZip(zipBuffer, {
            ...parsed.data,
